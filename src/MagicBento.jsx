                    ...
                    if (enableStars) {
                        return (
                            ...
                            >
                                ...
                                <div className="card__content" style={{ textAlign: 'center', marginTop: '0.5rem' }}>
                                    <h2 className="card__title" style={{ color: '#c69aed' }}>{card.title}</h2>
